  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved district as @district" do
        ...
        post :create, {:district => { "name" => "invalid value" }}, valid_session
        assigns(:district).should be_a_new(District)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested district" do
        ...
        District.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => district.to_param, :district => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the district as @district" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        District.any_instance.stub(:save).and_return(false)
        put :update, {:id => district.to_param, :district => { "name" => "invalid value" }}, valid_session
        assigns(:district).should eq(district)
      end
