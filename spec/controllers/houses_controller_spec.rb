...
describe HousesController do
  ...
  let(:valid_attributes) { FactoryGirl.attributes_for(:house) }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested house" do
        ...
        House.any_instance.should_receive(:update_attributes).with({ "street" => "" })
        put :update, {:id => house.to_param, :house => { "street" => "" }}, valid_session
      end
